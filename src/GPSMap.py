...
class Map:
    ...
    def __load_first_maps(self):
        if self.__firstImage == 0:
            self.__load_smallmap = Image.open(os.path.realpath(__file__)+"/.."+"/../Maps/Small Map.png")
            self.__load_smallmap.load()
            self.__load_smallmap.thumbnail(size=(width, height))
            self.__load_largemap = Image.open(os.path.realpath(__file__)+"/.."+"/../Maps/Large Map.png")
            self.__load_largemap.load()
            self.__load_largemap.thumbnail(size=(width, height))
        else:
            self.__load_smallmap = Image.open(os.path.realpath(__file__)+"/.."+"/../Maps/Small Map1.png")
            self.__load_smallmap.load()
            self.__load_smallmap.thumbnail(size=(width, height))
            self.__load_largemap = Image.open(os.path.realpath(__file__)+"/.."+"/../Maps/Large Map1.png")
            self.__load_largemap.load()
            self.__load_largemap.thumbnail(size=(width, height))
    ...
    def __load_Crosshair(self):
        self.__load_crosshair = Image.open(os.path.realpath(__file__)+"/.."+"/../appImages/Crosshair.png")
    ...
    def __load_Circle(self):
        self.__load_circle = Image.open(os.path.realpath(__file__)+"/.."+"/../appImages/circle.png")
    ...
    def __choose_first_map(self):
        ...
        if (self.__coordiantes[0] > self.__smallmap_side['top'] or self.__coordiantes[0] < self.__smallmap_side['bot']) or (self.__coordiantes[1] < self.__smallmap_side['left'] or self.__coordiantes[1] > self.__smallmap_side['right']):
            ...
            self.__load_largemap.save(os.path.realpath(__file__)+"/.."+"/../Maps/Large Map1.png")
            self.__load_smallmap.save(os.path.realpath(__file__)+"/.."+"/../Maps/Small Map1.png")
